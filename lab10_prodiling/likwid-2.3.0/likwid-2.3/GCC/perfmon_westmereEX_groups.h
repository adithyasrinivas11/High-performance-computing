...
#define NUM_GROUPS_WESTMEREEX 12
...
static PerfmonGroupMap westmereEX_group_map[NUM_GROUPS_WESTMEREEX] = {
    ...
    {"MEM",MEM,"Main memory bandwidth in MBytes/s","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,CPU_CLK_UNHALTED_REF:FIXC2,UNCORE_CYCLES:WBOX4,FVC_EV0_BBOX_CMDS_READS:MBOXA0,FVC_EV0_BBOX_RSP_ACK:MBOXA1,FVC_EV0_BBOX_CMDS_READS:MBOXB0,FVC_EV0_BBOX_RSP_ACK:MBOXB1,IMT_INSERTS_WR:BBOXA1,IMT_INSERTS_WR:BBOXB1,NEW_PACKETS_RECV_PORT0_IPERF0_ANY_DRS:RBOXA0,NEW_PACKETS_RECV_PORT1_IPERF0_ANY_DRS:RBOXA1,NEW_PACKETS_RECV_PORT4_IPERF0_ANY_DRS:RBOXB0,NEW_PACKETS_RECV_PORT5_IPERF0_ANY_DRS:RBOXB1,NULL_IDLE_PORT0_IPERF1:RBOXA2,NULL_IDLE_PORT1_IPERF1:RBOXA3,NULL_IDLE_PORT4_IPERF1:RBOXB2,NULL_IDLE_PORT5_IPERF1:RBOXB3"},
...
perfmon_printDerivedMetricsWestmereEX(PerfmonGroup group)
{
    ...
    switch ( group ) 
    {
        ...
        case MEM:
            ...
            bstrListAdd(fc,3,Uncore Clock [MHz] );
            ...
            for(threadId=0; threadId < perfmon_numThreads; threadId++)
            {
                ...
                tableData.rows[2].value[threadId] = 1.E-06*(perfmon_getResult(threadId,"WBOX4"))/time;
                stat[2][0] += (double) tableData.rows[2].value[threadId];
                stat[2][1] =  MAX(stat[2][1],(double) tableData.rows[2].value[threadId]);
                stat[2][2] =  MIN(stat[2][2],(double) tableData.rows[2].value[threadId]);

                tableData.rows[3].value[threadId] = perfmon_getResult(threadId,"FIXC1")/perfmon_getResult(threadId,"FIXC0");
                stat[3][0] += (double) tableData.rows[3].value[threadId];
                stat[3][1] =  MAX(stat[3][1],(double) tableData.rows[3].value[threadId]);
                stat[3][2] =  MIN(stat[3][2],(double) tableData.rows[3].value[threadId]);

                tableData.rows[4].value[threadId] = 1.0E-06*(perfmon_getResult(threadId,"MBOXA0")+perfmon_getResult(threadId,"MBOXB0"))*64/time;
                stat[4][0] += (double) tableData.rows[4].value[threadId];
                stat[4][1] =  MAX(stat[4][1],(double) tableData.rows[4].value[threadId]);
                stat[4][2] =  MIN(stat[4][2],(double) tableData.rows[4].value[threadId]);

                tableData.rows[5].value[threadId] = 1.0E-06*(perfmon_getResult(threadId,"BBOXA1")+perfmon_getResult(threadId,"BBOXB1"))*64/time;
                stat[5][0] += (double) tableData.rows[5].value[threadId];
                stat[5][1] =  MAX(stat[5][1],(double) tableData.rows[5].value[threadId]);
                stat[5][2] =  MIN(stat[5][2],(double) tableData.rows[5].value[threadId]);

                tableData.rows[6].value[threadId] = 1.0E-06*(perfmon_getResult(threadId,"MBOXA0")+perfmon_getResult(threadId,"MBOXB0")+perfmon_getResult(threadId,"BBOXA1")+perfmon_getResult(threadId,"BBOXB1"))*64/time;
                stat[6][0] += (double) tableData.rows[6].value[threadId];
                stat[6][1] =  MAX(stat[6][1],(double) tableData.rows[6].value[threadId]);
                stat[6][2] =  MIN(stat[6][2],(double) tableData.rows[6].value[threadId]);
...
perfmon_logDerivedMetricsWestmereEX(PerfmonGroup group, double time,double timeStamp)
{
    ...
    switch ( group ) 
    {
        ...
        case MEM:
                        ...
                        for(threadId=0; threadId < perfmon_numThreads; threadId++)
                        {
                            printf(" %e  ",1.E-06*(perfmon_getResult(threadId,"WBOX4"))/time);
                        }
                        printf("\n");
                        ...
                        for(threadId=0; threadId < perfmon_numThreads; threadId++)
                        {
                            printf(" %e  ",1.0E-06*(perfmon_getResult(threadId,"MBOXA0")+perfmon_getResult(threadId,"MBOXB0"))*64/time);
                        }
                        printf("\n");
                        ...
                        for(threadId=0; threadId < perfmon_numThreads; threadId++)
                        {
                            printf(" %e  ",1.0E-06*(perfmon_getResult(threadId,"BBOXA1")+perfmon_getResult(threadId,"BBOXB1"))*64/time);
                        }
                        printf("\n");
                        ...
                        for(threadId=0; threadId < perfmon_numThreads; threadId++)
                        {
                            printf(" %e  ",1.0E-06*(perfmon_getResult(threadId,"MBOXA0")+perfmon_getResult(threadId,"MBOXB0")+perfmon_getResult(threadId,"BBOXA1")+perfmon_getResult(threadId,"BBOXB1"))*64/time);
                        }
                        printf("\n");
